...
numbers.all.ag <- aggregate(numbers.all.m[,c("Intrans", "MisPress","MisPressIntrans","Error","ErrorIntrans")], by = list(f.id = numbers.all.m$f.id, Group = numbers.all.m$Group, Trialnumber = numbers.all.m$value), FUN = "sum.na")
```
...
#Save workspace
save.image("~/Dropbox/CDS/Transitivity/TransitivityOutputs/TransitivityDataOrgWorkspace052415.RData")
```